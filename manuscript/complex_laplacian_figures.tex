...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.9\linewidth]{figures/fig1_overview_v2.pdf}
...
\begin{figure}[ht]
 \centering
 \includegraphics[width = \linewidth]{figures/eigmode_examples.pdf}
...
\begin{figure}[ht]
 \centering
 \includegraphics[width = \linewidth]{figures/best_eignmodes.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width = 0.9\linewidth]{figures/coupled_parameters.pdf}
...
\begin{figure}[ht]
\centering
\includegraphics[width = 0.9\linewidth]{figures/tuning_vertical.pdf}
